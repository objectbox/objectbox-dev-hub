...
image: /img/social/api-fact-using-transactions-in-objectbox.jpg
---
...
<Head>
  <meta property="og:title" content="API Fact: Using Transactions in ObjectBox" />
  <meta property="og:description" content="Learn how to use transactions in ObjectBox with store.runInTx for atomic, consistent, and high-performance database operations." />
  <meta property="og:image" content="https://objectbox.io/dev-how-to/img/social/api-fact-using-transactions-in-objectbox.jpg" />
