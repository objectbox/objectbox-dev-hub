...
image: /img/social/how-on-device-vector-databases-with-data-sync-are-revolutionizing-field-services.jpg
---
...
<Head>
  <meta property="og:title" content="How On-Device Vector Databases with Data Sync Are Revolutionizing Field Services" />
  <meta property="og:description" content="Learn how an on-device vector database like ObjectBox with real-time data sync enables powerful, offline-first AI applications for industries like field services." />
  <meta property="og:image" content="https://objectbox.io/dev-how-to/img/social/how-on-device-vector-databases-with-data-sync-are-revolutionizing-field-services.jpg" />
