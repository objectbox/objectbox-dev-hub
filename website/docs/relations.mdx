---
title: "Relations in ObjectBox C++"
...
<TechnicalArticleSchema
  headline="Relations in ObjectBox C++"
  description="Learn how to create and update to-one and to-many relations between entities in ObjectBox C / C++ database."
...
![](/img/assets/spaces_-LETufmyus5LFkviJjr4_uploads_1fSQLwbLzX2umwPHx2o3_to-one-relations.webp)
