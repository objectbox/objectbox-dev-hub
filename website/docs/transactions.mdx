---
title: "Transactions in ObjectBox C++"
description: "The ObjectBox database is transactional and fully ACID compliant. ObjectBox gives developers Multiversion concurrency control (MVCC) semantics."
keywords:
  - objectbox
  - c++
  - cpp
...
<TechnicalArticleSchema
  headline="Transactions in ObjectBox C++"
  description="The ObjectBox database is transactional and fully ACID compliant. ObjectBox gives developers Multiversion concurrency control (MVCC) semantics."
  url="https://cpp.objectbox.io/transactions"
